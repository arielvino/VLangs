...
import { Box, Button, IconButton, Paper, Slider, Stack, TextField, Typography, useTheme } from '@mui/material';
import DeleteOutlined from '@mui/icons-material/DeleteOutlined';
import { getDirection, LANGUAGE_OPTIONS, type LanguageOption } from './LanguageSelector';
...
export const TabsList: React.FC<TabsListProps> = ({ createPressed, navigateToTab }) => {
...
export const TabCreation: React.FC<TabCreationProps> = ({ onCreate, onCancel }) => {
    ...
    return (
        <Paper variant={'elevation'} color={'background.paper'} elevation={2} sx={{ padding: 2 }}>
            <Stack spacing={2}>
